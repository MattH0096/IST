...
import { SOLUTIONS_FULL_STACK } from "@/lib/solutions";

/**
 * Full-stack approach — four FeatureCards matching sitewide card chrome.
 */
export function SolutionsFullStack() {
  return (
