 ...
 */
export function CrucibleQuestions() {
      ...
      <Container>
        <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-8 xl:gap-10">
            ...
            <Reveal variant="fromLeft">
              <ChassisFrame as="figure" media inert>
                <Image
                  ...
                  width={asset.width}
                  height={asset.height}
                  alt="Simulated terrain with modelled links between distributed assets, showing how geography shapes connectivity."
          ...
          <Reveal index={1} variant="fromRight" className="min-w-0">
            <h2 className="t-h2 text-balance text-ist-text">{CRUCIBLE.questionsHeading}</h2>

            <ul className="mt-8 flex flex-col gap-4 sm:mt-10 sm:gap-5">
              {CRUCIBLE.questions.map((question) => (
